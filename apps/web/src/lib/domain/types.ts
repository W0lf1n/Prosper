...
export interface Txn extends Synced {
	 ...
	 * actually cost". In the spreadsheet a five-figure door sat in the same column
...
export interface Schedule extends Synced {
	 ...
	 *
	 * The mortgage was the case Q46 was written for: the whole payment leaves
	 * the account and half comes back from the same person. Q47 added the Netflix
