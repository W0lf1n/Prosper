...
export const VOCABULARY: BucketVocabulary[] = [
	...
	{
		bucket: 'DARY',
		keywords: ['kytka', 'kyti', 'darek', 'narozeniny', 'vyroci', 'dort', 'sbirka']
	},
	{
	...
	{
		bucket: 'PŘÍJEM',
		keywords: ['vyplata', 'mzda', 'sporak', 'uroky', 'bonus', 'faktura']
	}
];
 ...
 *
 * Taken verbatim from the spreadsheet: "opak. obj" carried a five-figure sum in a
 * single month and explains none of it.
 */
const VAGUE = [
	'objednavka',
	'opak obj',
