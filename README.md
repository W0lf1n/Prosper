...
![566 tests](https://img.shields.io/badge/tests-510%20web%20%2B%2056%20api-007850.svg)
...
<img src="docs/screens/domu-dark.png" width="270" alt="Domů: the month’s net, a payment waiting to be confirmed, the goal’s month, and the wealth total">
<img src="docs/screens/zapis-light.png" width="270" alt="Zápis: a live check firing while typing — “Spíš JÍDLO?” with a one-tap fix">
<img src="docs/screens/prehled-dark.png" width="270" alt="Přehled: the month’s net, days without an expense, and the findings">
...
| `other-overflow`    | The dumping-ground bucket past 15 % of recurring outflow      | OSTATNÍ took roughly a sixth of all outflow  |
...
The third edition, since 2026-09-05: a consumer-banking layout — a soft-grey
...
| [`docs/DESIGN.md`](docs/DESIGN.md)                                | The design system — third edition, the consumer-banking layout       |
