...
The mortgage is set to `auto`. Everything else starts at `confirm`.
...
**The amount override never touches the schedule.** The gas bill is 2 000 Kč
most months and 3 000 Kč in February; correcting one month must not silently
...
```
hypotéka         30 000,00 Kč
15. · BYDLENÍ · automaticky    zbývá 100 plateb · 3 000 000,00 Kč

Netflix             379,00 Kč
3. · LIFESTYLE · potvrdit               4 548,00 Kč / rok
───────────────────────────────────────
Za měsíc                        30 379,00 Kč
Za rok                         364 548,00 Kč
```
...
**`zbývá 100 plateb`** is the mortgage question answered out of the ledger
